...
plotXaxs <- function(){
  axis(1, wk, labels = as.Date(wk), las = 3, cex.axis = 0.3)
}
```
...
legend("topleft", col = c(gray(0.4), colActif, colActifPb), pch = 16, 
       legend = c("Enregistrés (brut)", "Actifs (moy. 7j)", "Actifs, mais pb doublons données épi"), 
...
legend("topleft", col = c("white", colActif, colActifPb, colRegis, "white"), pch = 16, 
       legend = c("prop. utilisateurs ", "Actifs", "Actifs, données avec pb doublons", "Enregistrés"), 
