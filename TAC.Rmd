...
dlData <- FALSE # Whether to download the data again (TRUE if first time of the day)
...
```{r NotifsPerQR, fig.width=9, fig.height=6}
...
```{r EstimateActiveUsers, fig.width=7, fig.height=5}
par(xpd = TRUE)
