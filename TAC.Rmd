...
-  Epidemic data: 
   ...
   -  [data.gouv.fr](https://www.data.gouv.fr/en/datasets/r/d3a98a30-893f-47f7-96c5-2f4bcaaa0d71), dataset which used by JHU, for which date corresponds to the date of declaration and not date of test
...
par(xpd = TRUE)
points(c(0, dat.withEpi$P.WeekAve), c(0, dat.withEpi$diffQRPerDay.WeekAve), col = rgb(1-ii, 0, ii), pch = 16)
